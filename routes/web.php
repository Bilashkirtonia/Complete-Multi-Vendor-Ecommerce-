...
Route::get('/product/min/cart', [CartController::class, 'addMinCart']);
...
Route::get('became/vendor',[VendorController::class,'BecomeVendor'])->name('became.vendor');
...
Route::middleware(['auth','role:admin'])->group(function(){
    ...
    Route::get('admin/logout',[AdminController::class,'adminDestroy'])->name('admin_logout');
...
Route::middleware(['auth','role:user'])->group(function(){
    // Route::get('user/dashboard',[AdminController::class,'index'])->name('user_dashboard');
